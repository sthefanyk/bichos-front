...
export default function Home() {
    ...
    return (
        <>
             {/* Navbar */}
            <nav className='fixed bg-orangee-normal w-screen px-16 lg:px-32'>
            ...
            <header className='px-16 lg:px-32 bg-orangee-normal pt-20 lg:pt-24'>
                <div className='flex flex-col lg:flex-row items-center justify-between'>
                    <div className='flex flex-col py-20 gap-7 grow'>
                        <p className='text-beige-normal text-lg lg:text-xl font-semibold'>Divulgação, adoção e apadrinhamento de animais</p>
            ...
            <div className='lg:px-32 bg-beige-normal space-y-12 lg:space-y-16'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-x-4 gap-y-6 justify-betwee h-auto'>
