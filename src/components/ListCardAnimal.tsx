...
const ListCardAnimal = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-beige-normal space-y-12 lg:space-y-16">
            <div className="flex justify-center lg:space-x-16 border-b lg:border-b-2 border-darktext-normal w-[80%]">
            ...
            <h2 className="font-bold text-2xl lg:text-4xl w-[80%]">
                Bichos para adotar:
            </h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-x-4 gap-y-6 justify-between h-auto w-[80%]">
                {data.map((post: any) => (
                    <CardAnimal
                        key={post.id}
